...
import { accounts, diagramRevisions, diagrams, memberships, operationReceipts, projects, resources, resourceVersions, users } from '../src/infrastructure/database/schema.js';
