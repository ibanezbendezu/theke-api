...
export class ResourcesController {
  ...
  @Get() list(@AuthContext() auth: AuthContextValue, @Query('type') type?: string, @Query('cursor') cursor?: string) { return this.accountId(auth).then(accountId => this.resources.list(accountId, type, cursor)); }
